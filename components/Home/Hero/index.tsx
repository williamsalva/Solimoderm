...
const PRODUCTS: HeroProduct[] = [
  {
    id: 0,
    src: "/hero/hero_muebles_transparent.png",
  ...
  {
    id: 1,
    src: "/hero/hero_tarjas_transparent.png",
  ...
  {
    id: 2,
    src: "/hero/hero_espejo_transparent.png",
  ...
  {
    id: 3,
    src: "/hero/hero_ovalin_transparent.png",
  ...
  {
    id: 4,
    src: "/hero/hero_monomando_transparent.png",
